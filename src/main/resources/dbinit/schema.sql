...
-- SpringBatchに必要なテーブル、シーケンスをDROPするステートメント
-- https://github.com/spring-projects/spring-batch/blob/5.2.x/spring-batch-core/src/main/resources/org/springframework/batch/core/schema-drop-h2.sql
...
-- SpringBatchに必要なテーブル、シーケンスをCREATEするステートメント
-- https://github.com/spring-projects/spring-batch/blob/5.2.x/spring-batch-core/src/main/resources/org/springframework/batch/core/schema-h2.sql
